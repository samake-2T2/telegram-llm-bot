...
이 프로젝트는 개인 PC나 로컬 환경에 설치된 LLM(대형 언어 모델) 서버(예: LM Studio)를 활용하여 텔레그램 메신저와 연동하는 스마트 AI 챗봇입니다. 외부 API 비용 없이 오픈소스 AI 모델을 직접 구동하면서 실시간 대화 및 웹 검색 기반의 유용한 정보를 제공하는 것을 목표로 합니다.
